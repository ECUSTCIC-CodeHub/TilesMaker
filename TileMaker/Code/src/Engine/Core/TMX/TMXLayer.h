...
namespace TileMaker
{
    ...
    public:
        ...
        TMXLayer(const tmx::Map& map, std::size_t idx)
        {
            ...
            else
            {
                ...
                m_globalBounds = { {0, 0}, {mapSize.width, mapSize.height} };
            }
        }
    ...
    private:
        ...
        void createChunks(const tmx::Map& map, const tmx::TileLayer& layer)
        {
            ...
            sf::Image fallback;
            fallback = sf::Image({ 2, 2 }, sf::Color::Magenta);
            ...
            m_chunkCount.x = static_cast<m_uint8>(std::ceil(bounds.width / m_chunkSize.x));
            m_chunkCount.y = static_cast<m_uint8>(std::ceil(bounds.height / m_chunkSize.y));
